...
//
// PERFORMANCE NOTE
// mix-blend-mode: multiply forces the compositor to read both layers
// every paint, which causes scroll jank on mobile GPUs and low-end
// integrated laptop graphics. Desktop only.
