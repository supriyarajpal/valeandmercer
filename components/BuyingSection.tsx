      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 64, alignItems: 'center' }}>
        ...
        <div>
          ...
          <SlowReveal delay={0.05}>
            <h2 style={{ color: '#28231C', marginBottom: 20 }}>
          ...
          <SlowReveal delay={0.55}>
            <p style={{ fontSize: 14, lineHeight: 1.95, color: '#28231C', opacity: 0.78, marginBottom: 18, maxWidth: 520 }}>
          ...
          <SlowReveal delay={0.7}>
            <p style={{ fontFamily: 'var(--font-serif)', fontSize: 18, lineHeight: 1.7, color: '#28231C', opacity: 0.7, marginBottom: 32, fontStyle: 'italic', maxWidth: 520 }}>
