      ...
      <main style={{background:'#EFECE6',paddingTop:'120px',paddingBottom:'80px'}}>
        <div style={{maxWidth:'860px',margin:'0 auto',padding:'0 20px'}}>
          ...
          <div id="pn-11" style={sectionStyle}>
            ...
            <p style={pStyle}>We implement appropriate technical and organizational security measures as required by UK GDPR Article 32, including encryption, access controls, two-factor authentication, and secure cloud processing under Data Processing Agreements with our providers. We maintain a documented breach response procedure and will notify the ICO within 72 hours of any notifiable breach.</p>
          </div>
