...
export default function ComplaintsPage() {
  ...
  const h2Style:React.CSSProperties = {fontFamily:'Cormorant Garamond,Georgia,serif',fontSize:'22px',fontWeight:300,color:'var(--text)',marginBottom:'12px',marginTop:'0',paddingTop:'32px'}
    ...
    <>
      ...
      <main style={{background:'var(--surface)',paddingTop:'120px',paddingBottom:'80px'}}>
        <div style={{maxWidth:'780px',margin:'0 auto',padding:'0 20px'}}>
          ...
          <h1 style={{fontFamily:'Cormorant Garamond,Georgia,serif',fontSize:'clamp(32px,5vw,48px)',fontWeight:300,color:'var(--text)',marginBottom:'8px'}}>Complaints Policy</h1>
          <p style={{fontSize:'12px',color:'var(--text-faint)',marginBottom:'8px'}}>Vale and Mercer Ltd, Residential Lettings Agency</p>
          <p style={{fontSize:'12px',color:'var(--text-faint)',marginBottom:'32px'}}>Last Updated: June 2026 | Company No: 17212434</p>
          ...
          <div style={{marginBottom:'32px',paddingBottom:'32px',borderBottom:'0.5px solid var(--border)'}}>
            ...
            <div style={{overflowX:'auto',marginBottom:'16px'}}>
              <table style={tableStyle}>
                ...
                <tbody>
                  ...
                  <tr style={{background:'var(--surface-3)'}}><td style={{...tdStyle,fontWeight:500}}>Post</td><td style={tdStyle}>Vale and Mercer Ltd, 124 City Road, London EC1V 2NX</td></tr>
          ...
          <div style={{marginBottom:'32px',paddingBottom:'32px',borderBottom:'0.5px solid var(--border)'}}>
            ...
            {[
              ...
              <div key={s.step} style={{marginBottom:'16px',padding:'18px 20px',background:'var(--border)',borderLeft:'3px solid #A0845C'}}>
                <p style={{fontSize:'13px',fontWeight:500,color:'var(--text)',marginBottom:'6px'}}>{s.step}</p>
                <p style={{fontSize:'13px',color:'var(--text-muted)',lineHeight:1.8,margin:0}}>{s.desc}</p>
              </div>
            ))}
            <div style={{marginBottom:'16px',padding:'18px 20px',background:'var(--border)',borderLeft:'3px solid #A0845C'}}>
              <p style={{fontSize:'13px',fontWeight:500,color:'var(--text)',marginBottom:'8px'}}>Step 3: Full Written Response</p>
              <p style={{fontSize:'13px',color:'var(--text-muted)',lineHeight:1.8,marginBottom:'8px'}}>We will provide you with our full written response within <strong>15 working days</strong> of our acknowledgement. Our response will:</p>
              <ul style={{paddingLeft:'18px',margin:0}}>
                {['Address each point you have raised individually','Set out our findings clearly and transparently','State whether your complaint is upheld, partially upheld, or not upheld, with full reasoning','Offer a resolution or explanation where applicable'].map(item=>(
                  <li key={item} style={{fontSize:'13px',color:'var(--text-muted)',lineHeight:1.8,marginBottom:'2px'}}>{item}</li>
                ))}
              </ul>
              <p style={{fontSize:'13px',color:'var(--text-muted)',lineHeight:1.8,marginTop:'8px',marginBottom:0}}>If we are unable to respond within 15 working days, we will write to you in advance to explain why and provide a revised response date.</p>
            </div>
          </div>
            ...
            <div style={{overflowX:'auto',marginBottom:'16px'}}>
              <table style={tableStyle}>
                ...
                <tbody>
                  ...
                  <tr style={{background:'var(--surface-3)'}}><td style={{...tdStyle,fontWeight:500}}>Email</td><td style={tdStyle}><a href="mailto:complaints@theprs.co.uk" style={{color:'#A0845C'}}>complaints@theprs.co.uk</a></td></tr>
