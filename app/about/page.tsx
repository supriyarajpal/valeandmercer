          ...
          <div style={{ position: 'relative', zIndex: 10, maxWidth: 1280, margin: '0 auto', width: '100%' }}>
            <div style={{ maxWidth: 640 }}>
              ...
              <motion.p
                ...
                style={{ fontSize: 16, lineHeight: 2, color: 'rgba(239,236,230,0.96)', maxWidth: 460, textShadow: '0 2px 18px rgba(40,35,28,0.9), 0 1px 3px rgba(40,35,28,0.6)' }}
              >
        ...
        <section style={{ background: '#EFECE6', padding: 'var(--section-y) var(--gutter)' }}>
          <div style={{ maxWidth: 880, margin: '0 auto', position: 'relative' }}>
            <Reveal y={32} amount={0.25}>
              ...
              <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', background: 'rgba(40,35,28,0.82)', backdropFilter: 'blur(14px) saturate(140%)', WebkitBackdropFilter: 'blur(14px) saturate(140%)', padding: '72px 36px', boxShadow: '0 30px 80px -10px rgba(122,96,62,0.55), 0 0 0 1px rgba(160,132,92,0.18) inset', overflow: 'hidden', borderRadius: 10 }}>
                ...
                <div style={{ position: 'relative' }}>
                  <h2 style={{ color: '#FFFFFF', marginBottom: 18, fontSize: 'clamp(30px, 5vw, 50px)', textShadow: '0 2px 24px rgba(40,35,28,0.6)' }}>
                    Ready to have a conversation?
                  </h2>
                  <p style={{ fontSize: 15, lineHeight: 1.9, color: 'rgba(255,251,240,0.92)', marginBottom: 32, maxWidth: 420, margin: '0 auto 32px', textShadow: '0 1px 12px rgba(40,35,28,0.5)' }}>
...
function CtaButton({ href, label, filled }: { href: string; label: string; filled?: boolean }) {
  return (
    ...
    >
      <span data-fill aria-hidden style={{ position: 'absolute', inset: 0, background: filled ? '#1A1612' : '#FFFBF0', transform: 'translateX(-101%)', transition: 'transform 0.5s var(--ease-out-soft)', zIndex: 0 }} />
