...
const posts = [
  // Order is pinned: landlord checklist first, London rental market 2026 second,
  // then the remaining posts in their existing order. (Chelsea buying guide removed.)
